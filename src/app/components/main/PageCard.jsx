...
export default function PageCard() {
  return (
    <div className="flex w-auto mx-4 my-20 mt-48 justify-center items-center h-full">
      <Link
        href="/map"
        className="flex flex-col w-[340px] h-[480px] border border-gray-400 justify-center items-center rounded-full shadow-lg mr-36"
      >
      ...
      <Link
        href="/blog"
        className="flex flex-col w-[340px] h-[480px] border border-gray-400 justify-center items-center rounded-full shadow-lg ml-36"
      >
        <div className="mb-20 rounded-full">
